...
\begin{table} [tbp!]
    ...
    \scalebox{0.75}{
        \begin{tabular}{| l | l | l | l | l |}
            ...
            1 & Snoek \etal\cite{snoek2016university} & \specialcell{词袋向量(Bag-of-\\words)~\cite{sivic2003video}} & \specialcell{由VideoStory~\cite{habibian2014videostory}模型产生\\的词袋向量(Bag-of-words)} & \specialcell{文本特征空间} \\ \hline
